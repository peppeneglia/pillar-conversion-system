...
/**
 * Two-state preference control on the dark footer surface. The value is stored
 * in a cookie and applied by the server, so there is no flash on the next render.
 */
        ...
        {options.map((option) => {
          ...
          return (
            <label
              ...
              htmlFor={id}
              className={cn(
                "flex min-h-11 cursor-pointer items-center rounded-full px-4 text-sm font-medium",
